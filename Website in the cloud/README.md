...
+   Wix
    Wix is a cloud-based website development tool that allows users to create HTML5 websites. It has multiple cloud-based tools to edit website, including an Artifical Design Intelligence (ADI) interface to help build a personalized website.
